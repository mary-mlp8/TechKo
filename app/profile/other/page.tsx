...
export default function OtherProducerProfile() {
  const [isContactModalOpen, setIsContactModalOpen] = useState(false)
  // This simulates viewing someone else's profile while logged in
  const currentUser = "Maria" // The logged-in user
  const profileOwner = "João" // The profile being viewed
  ...
  return (
    <div className={`min-h-screen bg-white ${ibmPlexSans.variable} ${sora.variable} font-ibm`}>
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 mt-16 space-y-12">
        ...
        {/* Universal Contact Section - Available to All Users */}
